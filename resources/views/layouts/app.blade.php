...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="font-family: 'Segoe UI', Arial, sans-serif; background: #f8fafc; min-height: 100vh; margin: 0;">
        @if(request()->is('admin*') || request()->is('admindashboard') || request()->is('student-list') || request()->is('applicants') || request()->is('usermanagement') || request()->routeIs('Admin') || request()->routeIs('student.list') || request()->routeIs('applicants.list') || request()->routeIs('admin.usermanagement') || request()->routeIs('admin.sa-requests.*'))
