...
<body>
    <div style="max-width:900px;margin:0 auto;padding:24px;">
        ...
        <div style="background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.09);border:1px solid #dbeafe;max-width:900px;margin-bottom:32px;">
            ...
            <div style="padding:24px 18px 18px 18px;font-size:20px;line-height:1.5;color:#222;">
                ...
                <span style="font-size:16px;color:#888;">March 7, 2024</span>
            </div>
        </div>
        <div style="background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.09);border:1px solid #dbeafe;max-width:900px;margin-bottom:32px;">
