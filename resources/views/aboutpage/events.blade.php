...
<body>
    <div style="max-width:900px;margin:0 auto;padding:24px;">
        <div style="background:#1a237e;color:#fff;font-size:20px;font-weight:700;text-align:left;padding:10px 18px;border-radius:8px;margin-bottom:18px;max-width:900px;">EVENTS</div>
        <div style="background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.09);border:1px solid #dbeafe;max-width:900px;margin-bottom:32px;position:relative;">
            <img src="{{ asset('images/event1.png') }}" alt="event4" style="width:100%;max-width:900px;height:auto;object-fit:cover;border-radius:12px 12px 0 0;">
            <div style="padding:24px 18px 48px 18px;font-size:20px;line-height:1.5;color:#222;">
                UdD hosts first Luzon leg of GMA Masterclass Series<br>
                <span style="font-size:16px;color:#888;">March 6, 2024</span>
            </div>
            <a href="/event/1" style="position:absolute;right:18px;bottom:18px;background:#1a237e;color:#fff;padding:8px 18px;border-radius:6px;font-size:15px;text-decoration:none;font-weight:500;box-shadow:0 2px 8px rgba(0,0,0,0.07);">Read More</a>
        </div>
        <div style="background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.09);border:1px solid #dbeafe;max-width:900px;margin-bottom:32px;position:relative;">
            <img src="{{ asset('images/event2.png') }}" alt="event4" style="width:100%;max-width:900px;height:auto;object-fit:cover;border-radius:12px 12px 0 0;">
            <div style="padding:24px 18px 48px 18px;font-size:20px;line-height:1.5;color:#222;">
                SHS - Robotics Competition in Universidad<br>
                <span style="font-size:16px;color:#888;">March 27, 2025</span>
            </div>
            <a href="/event/2" style="position:absolute;right:18px;bottom:18px;background:#1a237e;color:#fff;padding:8px 18px;border-radius:6px;font-size:15px;text-decoration:none;font-weight:500;">Read More</a>
        </div>
        <div style="background:#fff;border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.09);border:1px solid #dbeafe;max-width:900px;margin-bottom:32px;position:relative;">
        ...
        <div style="margin-top:32px;text-align:center;">
            <a href="/about" style="background:#23408e;color:#fff;font-weight:bold;border-radius:6px;padding:8px 18px;text-decoration:none;">Back to About</a>
        </div>
    </div>
</body>
</html>